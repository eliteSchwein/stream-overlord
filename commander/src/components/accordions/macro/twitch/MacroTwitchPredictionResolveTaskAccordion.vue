<template>
  ...
  >
    <v-row>
      <v-col cols="12" md="6">
        <v-text-field v-model="task.data.prediction_id" variant="outlined" label="Prediction ID" placeholder="${prediction.id}" />
      </v-col>
      <v-col cols="12" md="6">
        <v-text-field v-model="task.data.winning_outcome_id" variant="outlined" label="Winning outcome ID" placeholder="${prediction.outcomes.0.id}" />
      </v-col>
    </v-row>
  </MacroTaskAccordionTemplate>
</template>
