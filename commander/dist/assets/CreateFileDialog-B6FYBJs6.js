import{Dt as e,Ft as t,It as n,Pn as r,Pt as i,Rt as a,dn as o,tn as s,zt as c}from"./dimensions-BXPgsWt0.js";import{E as l,W as u,d,n as f,r as p,u as m}from"./app-DzBD4znr.js";import{D as h,N as g,_,b as v}from"./index-CABs-UFN.js";import{t as y}from"./VSelect-CUUW8CdI.js";import{t as b}from"./VTextField-NvaWokWQ.js";import{t as x}from"./VAlert-C6eqfDJw.js";var S=Object.assign({"../../presets/macros/bits.yaml":`apis: []
tasks:
  - channel: alert
...
`}),C={props:{modelValue:{type:Boolean,default:!1},currentPath:{type:String,default:``},websocketMethod:{type:String,required:!0},presetFolder:{type:String,default:``},extension:{type:String,default:``},enforceExtension:{type:Boolean,default:!1},icon:{type:String,default:`mdi-file-plus`},title:{type:String,default:``},nameLabel:{type:String,default:``},presetLabel:{type:String,default:``},noPresetsLabel:{type:String,default:``},cancelLabel:{type:String,default:``},createLabel:{type:String,default:``}},emits:[`update:modelValue`,`created`],data(){return{name:``,selectedPreset:``,loading:!1}},computed:{normalizedPresetFolder(){return String(this.presetFolder??``).replace(/^@?\/?src\/?presets\/?/i,``).replace(/^@?\/?presets\/?/i,``).replace(/^\/+|\/+$/g,``)},normalizedExtension(){return String(this.extension??``).replace(/^\.+/,``).trim().toLowerCase()},extensionSuffix(){return!this.normalizedExtension||!this.enforceExtension?``:`.${this.normalizedExtension}`},presetItems(){let e=this.normalizedPresetFolder;return e?Object.keys(S).filter(t=>t.includes(`/presets/${e}/`)).sort((e,t)=>e.localeCompare(t)).map(e=>{let t=e.split(`/`).pop()?.replace(/\.(html|ya?ml)$/i,``)??e;return{title:this.formatPresetName(t),value:e}}):[]},canCreate(){return this.safeName.length>0&&(!this.presetItems.length||this.selectedPreset.length>0)},safeName(){return String(this.name??``).trim().replace(/^\/+/,``)},normalizedFileName(){let e=this.safeName,t=this.normalizedExtension;return t?this.enforceExtension?`${e.replace(/\.[^/.]+$/i,``)}.${t}`:e.toLowerCase().endsWith(`.${t}`)?e:`${e}.${t}`:e},targetPath(){return[String(this.currentPath??``).replace(/^\/+|\/+$/g,``),this.normalizedFileName].filter(Boolean).join(`/`)}},watch:{modelValue(e){e&&this.prepareDialog()},presetFolder(){this.selectedPreset=``,this.prepareDialog()}},mounted(){this.prepareDialog()},methods:{prepareDialog(){!this.selectedPreset&&this.presetItems.length&&(this.selectedPreset=this.presetItems[0].value)},close(){this.$emit(`update:modelValue`,!1),this.name=``,this.loading=!1},async requestWebsocket(e,t={},n=1e4){let r=g();if(!r)throw Error(`websocket is not connected`);let i=await r.request(e,t,n);return i?.params??i},getPresetContent(e){return e?String(S[e]??``):``},formatPresetName(e){return String(e??``).replace(/[-_]+/g,` `).replace(/\b\w/g,e=>e.toUpperCase())},async createFile(){if(!(!this.canCreate||this.loading)){this.loading=!0;try{await this.requestWebsocket(this.websocketMethod,{path:this.targetPath,content:this.getPresetContent(this.selectedPreset)}),this.$emit(`created`,this.targetPath),this.close()}catch(e){console.error(`file create failed`,e)}finally{this.loading=!1}}}}};function w(u,g,S,C,w,T){return s(),t(v,{"model-value":S.modelValue,"max-width":`520`,"onUpdate:modelValue":g[2]||=e=>u.$emit(`update:modelValue`,e)},{default:o(()=>[c(f,{color:`grey-darken-4`},{default:o(()=>[c(m,{class:`d-flex align-center ga-2`},{default:o(()=>[c(l,{icon:S.icon},null,8,[`icon`]),i(`span`,null,r(S.title||u.$t(`overlay.createFile`)),1)]),_:1}),c(p,null,{default:o(()=>[c(b,{modelValue:w.name,"onUpdate:modelValue":g[0]||=e=>w.name=e,label:S.nameLabel||u.$t(`file.name`),suffix:T.extensionSuffix,variant:`outlined`,density:`compact`,"hide-details":`auto`,class:`mb-3`,autofocus:``,onKeydown:e(T.createFile,[`enter`])},null,8,[`modelValue`,`label`,`suffix`,`onKeydown`]),T.presetItems.length?(s(),t(y,{key:0,modelValue:w.selectedPreset,"onUpdate:modelValue":g[1]||=e=>w.selectedPreset=e,items:T.presetItems,label:S.presetLabel||u.$t(`overlay.previewPreset`),variant:`outlined`,density:`compact`,"hide-details":`auto`,class:`mb-3`},null,8,[`modelValue`,`items`,`label`])):T.normalizedPresetFolder?(s(),t(x,{key:1,type:`info`,color:`grey-darken-3`,density:`compact`,variant:`tonal`,text:S.noPresetsLabel||u.$t(`file.noPresetsFound`)},null,8,[`text`])):n(``,!0)]),_:1}),c(d,null,{default:o(()=>[c(_),c(h,{variant:`text`,onClick:T.close},{default:o(()=>[a(r(S.cancelLabel||u.$t(`common.cancel`)),1)]),_:1},8,[`onClick`]),c(h,{color:`primary`,variant:`flat`,loading:w.loading,disabled:!T.canCreate,onClick:T.createFile},{default:o(()=>[a(r(S.createLabel||u.$t(`overlay.createFile`)),1)]),_:1},8,[`loading`,`disabled`,`onClick`])]),_:1})]),_:1})]),_:1},8,[`model-value`])}var T=u(C,[[`render`,w]]);export{T as t};