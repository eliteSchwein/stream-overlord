...
export default class TwitchClient {
    ...
    public async registerEvents(bot: Bot = this.bot as Bot, eventSub: EventSubWsListener = this.eventSub as EventSubWsListener) {
        ...
        const monetizationEventRegistrations = [
            ...
            ["channel hype train begin event", () => new ChannelHypeTrainBeginEvent(eventSub, bot, this).register()],
            ["channel hype train progress event", () => new ChannelHypeTrainProgressEvent(eventSub, bot, this).register()],
            ["channel hype train end event", () => new ChannelHypeTrainEndEvent(eventSub, bot, this).register()],
